...
const models = [
  ...
  },
  {
    ...
    provider: 'Kling',
    capability: 'video',
    description: '快手出品的视频生成模型，国内可用性强，适合快速生成漫剧视频片段。',
    docUrl: 'https://klingai.com/',
    pricingUrl: 'https://klingai.com/',
    apiBaseUrl: '',
    parameters: [
  ...
  },
  {
    ...
    provider: 'Kling',
    capability: 'video',
    description: '可灵 3.0 Turbo 视频生成模型，速度快，适合批量生成。',
    docUrl: 'https://klingai.com/',
    pricingUrl: 'https://klingai.com/',
    apiBaseUrl: '',
    parameters: [
  ...
  },
  {
    ...
    provider: 'Kling',
    capability: 'video',
    description: '可灵 2.0 视频生成模型，画质更高。',
    docUrl: 'https://klingai.com/',
    pricingUrl: 'https://klingai.com/',
    apiBaseUrl: '',
    parameters: [
    ...
    status: 'active',
    billingUnit: 'second',
    billingRule: { unitPrice: 0.15, currency: 'CNY', unit: 'per second' },
  },
  {
    id: 'doubao',
    name: '豆包 PixelDance',
