...
export default function GeneratePage() {
  ...
  const getProjectId = () => params.id as string;
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8"><div><BackButton href={`/projects/${getProjectId()}/studio`} label="故事编排" className="mb-2" /><h1 className="font-display text-3xl font-bold text-white mb-1">视频生成</h1><p className="text-text-secondary">将分镜转为视频片段</p></div><Button className="gap-2"><WandIcon className="w-4 h-4"/>全部生成</Button></div>
