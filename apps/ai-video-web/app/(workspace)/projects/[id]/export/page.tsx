...
export default function ExportPage() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8"><div><BackButton href={`/projects/${getProjectId()}/studio`} label="故事编排" className="mb-2" /><h1 className="font-display text-3xl font-bold text-white mb-1">后期导出</h1><p className="text-text-secondary">合成并导出最终视频</p></div><Button size="lg" className="gap-2">导出视频</Button></div>
